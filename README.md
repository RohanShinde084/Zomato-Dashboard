...
Compare restaurants offering online ordering services.
...
Cuisine Filter – View data for specific cuisines.
Online Order Filter – Filter restaurants based on online ordering availability.
2. KPI Cards
Total Restaurants: 23K
Total Votes: 14M
Average Cost: ₹755.90
3. Visualizations
📍 Restaurant by Location

Displays the count of restaurants across different locations.

🍴 Restaurant by Cuisine

Shows the most popular cuisine categories based on restaurant count.
...
Tool: Power BI
Domain: Food & Restaurant Analytics# Zomato-Dashboard
